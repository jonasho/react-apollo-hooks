...
export declare function useQuery<TData = any, TVariables = OperationVariables>(query: DocumentNode, { skip, suspend, pollInterval, notifyOnNetworkStatusChange, context, metadata, variables, fetchPolicy, errorPolicy, fetchResults, }?: QueryHookOptions<TVariables>): QueryHookResult<TData, TVariables>;
