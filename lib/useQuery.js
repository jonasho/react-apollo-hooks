...
function isFetching(networkStatus) {
  return networkStatus === _apolloClient.NetworkStatus.loading || networkStatus === _apolloClient.NetworkStatus.refetch;
}
...
function useQuery(query, _temp) {
  var _ref = _temp === void 0 ? {} : _temp,
      ...
      suspend = _ref$suspend === void 0 ? true : _ref$suspend,
      pollInterval = _ref.pollInterval,
      notifyOnNetworkStatusChange = _ref.notifyOnNetworkStatusChange,
